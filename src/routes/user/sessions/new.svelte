...
<script lang="ts">
	...
	import type {CopySessionRequest, CopySessionResponse} from '$lib/apitypes';
...
<div class="px-2">
	...
	<div class="w-full grid grid-cols-1 gap-1 mb-4 text-sm font-medium py-2">
		{#each sessions as session}
			<div on:click={() => selectSession(session)} class:bg-gray-100="{session===selected}"
			     class="w-full rounded-md py-1 px-2 border border-grey-300">
