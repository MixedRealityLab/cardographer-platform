...
<div class="flex flex-col md:flex-col-reverse h-screen w-screen" style="height: 100svh">
	{#if data.decks}
		...
		<div class="flex p-3 gap-2 relative">
			...
			<button class="button button-tool" title="Random Card" onclick={randomCard} aria-label="Random Card">
			...
			{#if categories.length > 1}
				<button use:menu.button onchange={onSelect} class="button button-tool"
